...
class VideoChatViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImageView= findViewById(R.id.shareScrIV)
...
//      mRtcEngine!!.setVideoProfile(Constants.VIDEO_PROFILE_360P, false) // Earlier than 2.3.0
    ...
    private fun joinChannel() {
        ...
        mRtcEngine!!.joinChannel(token, "Chanel 2", "Extra Optional Data", 0) // if you do not specify the uid, we will generate the uid for you
    }
    ...
    private fun startService() {
        ...
        serviceIntent.putExtra("Chanel 2","")
        ContextCompat.startForegroundService(this, serviceIntent)
        startForegroundService(serviceIntent)
        val intent= Intent(applicationContext,OpenGLES20Activity::class.java)
